...
def test_delete_role_API_004():
    logger=LogGen.loggen()
    url = ReadConfig.sm()
    com = common()
    headers = com.headers()
    logger.info("****************  Test_004: Test delete Role when user sends  -  userRolename null Request ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164305?projectId=50")
    print("****************  Test_004: Test delete Role when user sends  -  userRolename null Request ****************")
