...
def test_delete_role_API_002():
    logger=LogGen.loggen()
    url = ReadConfig.sm()
    com = common()
    logger.info("****************  Test_002: Test delete Role when user sends  -  Minimum Body Request ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164305?projectId=50")
    print("****************  Test_002: Test delete Role when user sends  -  Minimum Body Request ****************")
