...
class Test_002_Select_Activate_Button_close:
    ...
    def test_select_activate_button_close_002(self,setup):
        self.logger.info("****************  Test_002 : Test Activate option when user  Click Activate button and Close button. ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164257?projectId=50")
        print(
            "****************  Test_002 : Test Activate option when user  Click Activate button and Close button. ****************")
