...
class Test_003_Select_Activate_Button_x_button:
    ...
    def test_select_activate_button_close_003(self,setup):
        self.logger.info("****************  In Description ::TestCase_003 : Test Activate option when user  Click Activate button and select * button. ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164257?projectId=50")
        print(
            "****************  In Description ::TestCase_003 : Test Activate option when user  Click Activate button and select * button. ****************")
