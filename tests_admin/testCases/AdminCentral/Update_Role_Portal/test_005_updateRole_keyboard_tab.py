...
class Test_005_UpdateRole_Keyboard_Tab:
    ...
    def test_updateRole_keyboard_tab_005(self,setup):
        self.logger.info("****************  Test_005 : Test UpdateRole when user  access with Keyboard Tabbing  ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164242?projectId=50")
        print("****************  Test_005 : Test UpdateRole when user  access with Keyboard Tabbing  ****************")
