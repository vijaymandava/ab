...
class Test_023_UpdateUser_FirstName_ApartFrom_RegEx:
    ...
    def test_updateUser_firstName_apartFrom_RegEx_023(self,setup):
        self.logger.info("****************  Test_023:: Test UpdateUser when user sends 'FirstName' values apart from RegularEx ^[a-zA-Z0-9]+$  ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_023:: Test UpdateUser when user sends 'FirstName' values apart from RegularEx ^[a-zA-Z0-9]+$  ****************")
        print(
