...
class Test_005_UpdateUser_keyboard:
    ...
    def test_UpdateUser_keyboard_005(self,setup):
        self.logger.info("****************  Test_005 ::Test UpdateUser when user  access with Keyboard Tabbing  ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_005 ::Test UpdateUser when user  access with Keyboard Tabbing  ****************")
        print(
