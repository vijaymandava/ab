...
class Test_054_UpdateUser_Password_LimitPlusOne:
    ...
    def test_UpdateUser_password_limitPlusOne_054(self,setup):
        self.logger.info("****************  Test_054:: Test UpdateUser by sending password above 32 characters ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_054:: Test UpdateUser by sending password above 32 characters ****************")
        print(
