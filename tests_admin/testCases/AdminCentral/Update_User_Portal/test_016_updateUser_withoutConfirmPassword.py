...
class Test_016_UpdateUser_withoutConfirmPassword:
    ...
    def test_UpdateUser_withoutConfirmPassword_016(self,setup):
        self.logger.info("****************  Test_016 :: Test UpdateUser when user   Try to update without ConfirmPassword ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_016 :: Test UpdateUser when user   Try to update without ConfirmPassword ****************")
        print(
