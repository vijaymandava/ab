...
class Test_014_UpdateUser_withoutTelephone:
    ...
    def test_UpdateUser_withoutTelephone_014(self,setup):
        self.logger.info("****************  Test_014::Test UpdateUser when user   Try to update without Telephone  ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_014::Test UpdateUser when user   Try to update without Telephone  ****************")
        print(
        ...
        self.user.send_telephone_empty()
