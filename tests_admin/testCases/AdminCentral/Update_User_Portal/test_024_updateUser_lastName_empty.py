...
class Test_024_UpdateUser_LastName_Empty:
    ...
    def test_UpdateUser_lastName_empty_024(self,setup):
        self.logger.info("****************  Test_024:: Test UpdateUser when user sends 'LastName' value as Empty ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_024:: Test UpdateUser when user sends 'LastName' value as Empty ****************")
        print(
