...
class Test_037_UpdateUser_Email_ApartFrom_RegEx:
    ...
    def test_updateUser_email_apartFrom_RegEx_037(self,setup):
        self.logger.info("****************  Test_037:: Test UpdateUser when user sends 'EmailAddress' apart from the regular expression ^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$ ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_037:: Test UpdateUser when user sends 'EmailAddress' apart from the regular expression ^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$ ****************")
        print(
