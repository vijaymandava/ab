...
class Test_007_UpdateUser_mouseHover:
    ...
    def test_UpdateUser_mouseHover_007(self,setup):
        self.logger.info("****************  Test_007 :: Test UpdateUser when user  access with Mouse Hover ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_007 :: Test UpdateUser when user  access with Mouse Hover ****************")
        print(
