...
class Test_047_UpdateUser_PhoneNumber_EndWithSpace:
    ...
    def test_updateUser_phoneNumber_endWithSpace_047(self,setup):
        self.logger.info("****************  Test_047:: Test UpdateUser when user sends 'PhoneNumber' End with space ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_047:: Test UpdateUser when user sends 'PhoneNumber' End with space ****************")
        print(
        ...
        self.driver.find_element_by_id("telephoneNumber").send_keys("123567   ")
