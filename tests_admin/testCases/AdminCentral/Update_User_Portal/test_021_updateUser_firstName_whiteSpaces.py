...
class Test_021_UpdateUser_FirstName_Spaces:
    ...
    def test_UpdateUser_firstName_spaces_021(self,setup):
        self.logger.info("****************  Test_021 :: Test UpdateUser when user sends 'FirstName' value as whitespaces ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_021 :: Test UpdateUser when user sends 'FirstName' value as whitespaces ****************")
        print(
