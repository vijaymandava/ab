...
class Test_045_UpdateUser_PhoneNumber_RegEx:
    ...
    def test_updateUser_phonenumber_RegEx_045(self,setup):
        self.logger.info("****************  Test_045:: Test UpdateUser when user sends 'PhoneNumber' as with RegEx :^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$ ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_045:: Test UpdateUser when user sends 'PhoneNumber' as with RegEx :^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$ ****************")
        print(
