...
class Test_029_UpdateUser_middleInitial_RegEx:
    ...
    def test_updateUser_middleInitial_Regex_029(self,setup):
        self.logger.info("****************  Test_029:: Test UpdateUser when user sends 'Middle Initial' values with RegularEx ^([a-zA-Z]+)$ ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_029:: Test UpdateUser when user sends 'Middle Initial' values with RegularEx ^([a-zA-Z]+)$ ****************")
        print(
