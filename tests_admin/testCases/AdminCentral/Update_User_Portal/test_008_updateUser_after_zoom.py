...
class Test_008_UpdateUser_zoom:
    ...
    def test_UpdateUser_zoom_008(self,setup):
        self.logger.info("**************** Test_008 :: Test UpdateUser when user  access after Zoomin/ZoomOut ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "**************** Test_008 :: Test UpdateUser when user  access after Zoomin/ZoomOut ****************")
        print(
