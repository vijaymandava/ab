...
class Test_039_UpdateUser_Email_LessThan_64Before_AtTheRate:
    ...
    def test_updateUser_email_lessthan_64Characters_039(self,setup):
        self.logger.info("****************  Test_039:: Test UpdateUser when user sends 'EmailAddress'  less than 64 characters  before @ ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_039:: Test UpdateUser when user sends 'EmailAddress'  less than 64 characters  before @ ****************")
        print(
