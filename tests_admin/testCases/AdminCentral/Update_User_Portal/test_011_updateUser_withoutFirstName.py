...
class Test_011_UpdateUser_withoutFirstname:
    ...
    def test_UpdateUser_withoutFirstname_011(self,setup):
        self.logger.info("**************** Test_011:: Test UpdateUser when user   Try to update without FirstName ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "**************** Test_011:: Test UpdateUser when user   Try to update without FirstName ****************")
        print(
