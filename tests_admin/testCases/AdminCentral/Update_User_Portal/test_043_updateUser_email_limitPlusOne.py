...
class Test_043_UpdateUser_Email_LimitPlusOne:
    ...
    def test_updateUser_email_limitPlusOne_043(self,setup):
        self.logger.info("****************  Test_043:: Test UpdateUser when user sends 'EmailAddress' with 254+1 characters(all the characters after and before @) ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "****************  Test_043:: Test UpdateUser when user sends 'EmailAddress' with 254+1 characters(all the characters after and before @) ****************")
        print(
