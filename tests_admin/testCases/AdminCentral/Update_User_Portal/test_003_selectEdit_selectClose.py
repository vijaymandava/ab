...
class Test_003_UpdateUser_selectClose:
    ...
    def test_UpdateUser_selectClose_003(self,setup):
        self.logger.info("**************** Test_003:: Test UpdateUser when user  Click 'Edit' button and select close button ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164254?projectId=50")
        print(
            "**************** Test_003:: Test UpdateUser when user  Click 'Edit' button and select close button ****************")
        print(
