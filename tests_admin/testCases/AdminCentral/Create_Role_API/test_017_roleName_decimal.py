...
def test_roleName_decimalNumbers_017():
    logger = LogGen.loggen()
    com = Common_role_api()
    logger.info("****************  IN Description: TestCase_017: Test CreateRole when user sends  - 'userRoleName' with values :: decimalNumbers ****************")
    print("In Description :Testcase_017: Test CreateRole when user sends  - userRoleName with values :: decimalNumbers")
    ...
    roleName = role.userRolename_decimal()
    files = readFiles()
