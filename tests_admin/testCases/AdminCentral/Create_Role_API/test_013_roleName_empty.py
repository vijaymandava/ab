...
def test_roleName_empty_013():
    ...
    com = Common_role_api()
    logger.info("****************  IN Description: TestCase_013: Test CreateRole when user sends  - 'userRoleName' with values :: empty ****************")
    print("In Description :Testcase_013: Test CreateRole when user sends  - userRoleName with values :: empty")
