...
def test_roleName_characters_009():
    logger = LogGen.loggen()
    com = Common_role_api()
    logger.info("****************  IN Description: TestCase_009: Test CreateRole when user sends  userRoleName with values :: characters(a-zA-Z0-9)****************")
    print("In Description :Testcase_009: Test CreateRole when user sends   userRoleName with values :: characters(a-zA-Z0-9) ")
    ...
    roleName = role.userRolename_characters()
    files = readFiles()
