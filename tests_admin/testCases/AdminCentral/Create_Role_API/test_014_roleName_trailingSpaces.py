...
def test_roleName_trailingSpaces_014():
    logger = LogGen.loggen()
    com = Common_role_api()
    logger.info("****************  IN Description: TestCase_014: Test CreateRole when user sends  - 'userRoleName' with values :: TrailingSpaces ****************")
    print("In Description :Testcase_014: Test CreateRole when user sends  - userRoleName with values :: TrailingSpaces")
    ...
    roleName = role.userRolename_trailing_spaces()
    files = readFiles()
