...
def test_roleName_lowerCase_007():
    logger = LogGen.loggen()
    com = Common_role_api()
    logger.info("****************  IN Description: TestCase_007: Test CreateRole when user sends  - 'userRoleName' with values :: lowercase alphabets(A-Z) ****************")
    print("In Description :Testcase_007: Test CreateRole when user sends  - 'userRoleName' with values :: lowercase alphabets(A-Z)")
    ...
    roleName = role.userRolename_lowercase()
    files = readFiles()
