...
def test_roleName_min_002():
    logger = LogGen.loggen()
    com = Common_role_api()
    file_body = readFiles()
    logger.info(
        "**************** In Description: TestCase_002: Test CreateRole when user sends  - userRoleName with minimum value ****************")
    print("In Description :Testcase_002: Test CreateRole when user sends  - userRoleName with minimum value")
    ...
    roleName = role.userRolename_single_character()
