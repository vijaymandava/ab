...
def test_roleName_upperCase_006():
    logger = LogGen.loggen()
    com = Common_role_api()
    logger.info("****************  IN Description: TestCase_006: Test CreateRole when user sends  - 'userRoleName' with values :: uppercase alphabets(A-Z) ****************")
    print("In Description :Testcase_006: Test CreateRole when user sends  - 'userRoleName' with values :: uppercase alphabets(A-Z)")
    ...
    roleName = role.userRolename_uppercase()
    files = readFiles()
