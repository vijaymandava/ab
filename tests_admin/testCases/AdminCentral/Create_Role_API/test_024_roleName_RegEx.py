...
def test_roleName_RegEx_024():
    logger = LogGen.loggen()
    com = Common_role_api()
    logger.info("****************  IN Description: TestCase_024: Test CreateRole by sending the userRoleName RegEx : ^[a-zA-Z0-9\-_()'.#\\+ ]*$ ****************")
    print("In Description :Testcase_024: Test CreateRole by sending the userRoleName RegEx : ^[a-zA-Z0-9\-_()'.#\\+ ]*$")
