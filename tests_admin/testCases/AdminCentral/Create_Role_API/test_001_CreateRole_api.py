...
def test_createRole_001():
    ...
    com = Common_role_api()
    file_body = readFiles()
    logger.info("**************** In Description: TestCase_001: Test CreateRole when user sends  -  Valid Request ****************")
    print("In Description :Testcase_001: Test CreateRole when user sends  -  Valid Request")
    ...
    # Verify Created user present in the  SM UI - Roles list
