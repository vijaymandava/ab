...
def test_roleName_editedBy_RegEx_026():
    logger = LogGen.loggen()
    com = Common_role_api()
    logger.info("****************  IN Description: TestCase_026: Test CreateRole by sending the EditBy RegEx : ^[a-zA-Z0-9]+$ ****************")
    print("In Description :Testcase_026: Test CreateRole by sending the EditBy RegEx : ^[a-zA-Z0-9]+$")
    ...
    editedby = x.xeger("^[a-zA-Z0-9]+$")

    print("\n Sending editedBy value :: ", editedby)
