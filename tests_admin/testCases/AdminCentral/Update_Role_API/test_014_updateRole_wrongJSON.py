...
def test_updateRole_wrong_JSON_014():
    logger = LogGen.loggen()
    com = Common_role_api()
    logger.info("****************  Test_014: Test updateRole when user sends  -  invalid JSON ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164302?projectId=50")
    print("****************  Test_014: Test updateRole when user sends  -  invalid JSON ****************")
