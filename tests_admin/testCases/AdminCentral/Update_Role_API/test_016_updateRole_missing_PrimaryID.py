...
def test_updateRole_missing_primaryID_016():
    logger = LogGen.loggen()
    com = Common_role_api()
    logger.info("****************  Test_016: Test updateRole when user sends  - Request body by missing primaryID ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164302?projectId=50")
    print("****************  Test_016: Test updateRole when user sends  - Request body by missing primaryID ****************")
    ...
    body = {'editedBy': 'admin', 'userRoleName': roleName, 'deleteActionAlertLevel': 'true',
