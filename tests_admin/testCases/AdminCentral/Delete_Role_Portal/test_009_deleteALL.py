...
class Test_009_DeleteRole_SelectDelete_and_x:
    ...
    def test_selectDelete_and_x_003(self, setup):
        self.logger.info("****************  Test_009 :Test DeleteRole when user Click 'Delete' button and cross(x) button. ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164245?projectId=50")
        print("****************  Test_009 :Test DeleteRole when user Click 'Delete' button and cross(x) button. ****************")
        print(
        ...
        self.RolesList.deleteAll_roles()
