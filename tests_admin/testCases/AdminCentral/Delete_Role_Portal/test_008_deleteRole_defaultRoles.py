...
class Test_008_DeleteRole_SelectDelete_and_x:
    ...
    def test_selectDelete_and_x_008(self, setup):
        self.logger.info("****************  Test_008 :Test DeleteRole when user Click 'Delete' button and cross(x) button. ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164245?projectId=50")
        print("****************  Test_008 :Test DeleteRole when user Click 'Delete' button and cross(x) button. ****************")
