...
class Test_020_CreateUser_UserName_Empty:
    ...
    def test_userName_Empty_020(self, setup):
        self.logger.info("****************  test_020 ::  Test CreateUser when user sends 'userName' with values :: SQL injection ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  test_020 ::  Test CreateUser when user sends 'userName' with values :: SQL injection ****************")
