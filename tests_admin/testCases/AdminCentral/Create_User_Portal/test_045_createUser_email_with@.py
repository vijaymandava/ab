...
class Test_045_CreateUser_email:
    ...
    def test_createUser_email_045(self,setup):
        self.logger.info("****************  Test_045:: Test createUser when user sends 'EmailAddress' with @ ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_045:: Test createUser when user sends 'EmailAddress' with @ ****************")
