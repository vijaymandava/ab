...
class Test_016_CreateUser_UserName_Alphabets_Numbers:
    ...
    def test_userName_Alphabets_Numbers_016(self, setup):
        self.logger.info(
            "****************  Test_016 Test CreateUser when user sends userName with values :: Alphabets and Numbers ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_016 Test CreateUser when user sends userName with values :: Alphabets and Numbers ****************")
