...
class Test_041_CreateUser_middleInitial_RegEx:
    ...
    def test_createUser_middleInitial_Regex_041(self,setup):
        self.logger.info("****************  Test_041:: Test CreateUser when user sends 'Middle Initial' values with RegularEx ^([a-zA-Z]+)$ ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_041:: Test CreateUser when user sends 'Middle Initial' values with RegularEx ^([a-zA-Z]+)$ ****************")
