...
class Test_002_SelectAdd_SelectOptions:
    ...
    def test_selectAdd_selectOptions_002(self,setup):
        self.logger.info("****************  Test_002:: Test CreateUser when user Click ADD button and select options. ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_002:: Test CreateUser when user Click ADD button and select options. ****************")
