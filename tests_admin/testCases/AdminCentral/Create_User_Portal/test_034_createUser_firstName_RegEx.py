...
class Test_034_CreateUser_firstName_RegEx:
    ...
    def test_createUser_firstName_RegEx_034(self,setup):
        self.logger.info("****************  Test_034 :: Test CreateUser when user sends 'FirstName' values with RegularEx ^[a-zA-Z0-9]+$   ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_034 :: Test CreateUser when user sends 'FirstName' values with RegularEx ^[a-zA-Z0-9]+$   ****************")
