...
class Test_010_CreateUser_UserName_MaxLength:
    ...
    def test_MaxLength_010(self, setup):
        self.logger.info("****************  Test_010 Test CreateUser when user sends userName with maximum value(54) ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_010 Test CreateUser when user sends userName with maximum value(54) ****************")
