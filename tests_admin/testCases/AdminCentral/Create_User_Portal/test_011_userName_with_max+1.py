...
class Test_011_CreateUser_UserName_MaxPlusOne:
    ...
    def test_MaxPlusOne_011(self, setup):
        self.logger.info(
            "****************  Test_011 Test CreateUser when user sends userName with Maximum+1 value(55) ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_011 Test CreateUser when user sends userName with Maximum+1 value(55) ****************")
