...
class Test_043_CreateUser_MiddleInitial_ApartFrom_RegEx:
    ...
    def test_createUser_middleInitial_apartFrom_RegEx_043(self,setup):
        self.logger.info("****************  Test_043:: Test createUser when user sends 'Middle Initial' values apart from RegularEx ^([a-zA-Z]+)$ ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_043:: Test createUser when user sends 'Middle Initial' values apart from RegularEx ^([a-zA-Z]+)$ ****************")
