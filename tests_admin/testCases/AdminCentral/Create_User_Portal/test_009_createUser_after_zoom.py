...
class Test_009_UpdateUser_zoom:
    ...
    def test_UpdateUser_zoom_009(self,setup):
        self.logger.info("**************** Test_009 :: Test CreateUser when user access after Zoomin/ZoomOut ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("**************** Test_009 :: Test CreateUser when user access after Zoomin/ZoomOut ****************")
        ...
        self.user.select_users_Link_after_zoom()
        self.user.select_add_button_after_zoom()
