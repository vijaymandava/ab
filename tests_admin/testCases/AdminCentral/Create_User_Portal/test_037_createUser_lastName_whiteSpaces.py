...
class Test_037_CreateUser_LastName_WhiteSpaces:
    ...
    def test_createUser_lastName_whiteSpaces_037(self,setup):
        self.logger.info("****************  Test_037:: Test createUser when user sends 'LastName' value as whitespaces ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_037:: Test createUser when user sends 'LastName' value as whitespaces ****************")
