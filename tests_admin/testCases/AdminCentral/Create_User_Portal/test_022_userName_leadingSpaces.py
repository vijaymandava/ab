...
class Test_022_CreateUser_UserName_LeadingSpaces:
    ...
    def test_userName_leadingSpaces_022(self, setup):
        self.logger.info(
            "****************  test_022 ::  Test CreateUser when user sends 'userName'' with values :: "
            "Leadingspace(Before the user name place spaces) ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  test_022 ::  Test CreateUser when user sends 'userName'' with values :: "
            "Leadingspace(Before the user name place spaces) ****************")
