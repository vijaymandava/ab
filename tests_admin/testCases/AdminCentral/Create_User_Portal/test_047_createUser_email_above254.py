...
class Test_047_CreateUser_Email_Above254Characters:
    ...
    def test_createUser_email_above254Characters_047(self,setup):
        self.logger.info("****************  Test_047:: Test CreateUser when user sends 'EmailAddress' above 254 characters ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_047:: Test CreateUser when user sends 'EmailAddress' above 254 characters ****************")
