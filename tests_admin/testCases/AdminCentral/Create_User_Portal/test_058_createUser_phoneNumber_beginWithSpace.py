...
class Test_058_CreateUser_PhoneNumber_BeginWithSpace:
    ...
    def test_createUser_phonenumber_beginWithSpace_058(self,setup):
        self.logger.info("****************  Test_058:: Test CreateUser when user sends 'PhoneNumber' begin with space ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_058:: Test CreateUser when user sends 'PhoneNumber' begin with space ****************")
