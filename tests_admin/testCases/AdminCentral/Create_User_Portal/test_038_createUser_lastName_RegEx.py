...
class Test_038_CreateUser_LastName_RegEx:
    ...
    def test_createUser_lastname_RegEx_038(self,setup):
        self.logger.info("****************  Test_038:: Test createUser when user sends 'LastName' values with RegularEx ^[a-zA-Z0-9]+$  ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_038:: Test createUser when user sends 'LastName' values with RegularEx ^[a-zA-Z0-9]+$  ****************")
