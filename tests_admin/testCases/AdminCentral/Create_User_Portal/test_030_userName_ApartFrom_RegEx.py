...
class Test_030_userName_ApartFrom_RegEx:
    ...
    def test_userName_ApartFrom_RegEx_030(self,setup):
        self.logger.info("****************  Test_030 :: Test CreateUser by sending the userName apart from  ^[a-zA-Z0-9\-_()'.#\\+ ]*$  (ex:- ?,@ etc.,)  ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_030 :: Test CreateUser by sending the userName apart from  ^[a-zA-Z0-9\-_()'.#")
        ...
        for i in list:
            print(i)
            self.user.send_userName_runtime(i)
