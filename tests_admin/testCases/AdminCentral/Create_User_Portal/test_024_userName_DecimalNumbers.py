...
class Test_024_CreateUser_UserName_DecimalNumbers:
    ...
    def test_userName_decimalNumbers_024(self, setup):
        self.logger.info(
            "****************  test_024 ::  Test CreateUser when user sends 'userName' with values :: decimal numbers ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  test_024 ::  Test CreateUser when user sends 'userName' with values :: decimal numbers ****************")
