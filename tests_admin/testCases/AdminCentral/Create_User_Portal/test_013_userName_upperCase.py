...
class Test_013_CreateUser_UserName_UpperCase:
    ...
    def test_userName_UpperCase_013(self, setup):
        self.logger.info(
            "****************  Test_013 :: Test Createuser when user sends userName with values :: uppercase alphabets ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_013 :: Test Createuser when user sends userName with values :: uppercase alphabets ****************")
