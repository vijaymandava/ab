...
class Test_033_CreateUser_FirstName_Spaces:
    ...
    def test_CreateUser_firstName_spaces_033(self,setup):
        self.logger.info("****************  Test_033 :: Test CreateUser when user sends 'FirstName' value as whitespaces ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_033 :: Test CreateUser when user sends 'FirstName' value as whitespaces ****************")
