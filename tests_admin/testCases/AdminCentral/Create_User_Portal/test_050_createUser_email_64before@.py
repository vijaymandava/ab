...
class Test_050_CreateUser_Email_64Before_AtTheRate:
    ...
    def test_createUser_email_64Characters_050(self,setup):
        self.logger.info("****************  Test_050:: Test CreateUser when user sends 'EmailAddress'  64 characters  before @ ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  Test_050:: Test CreateUser when user sends 'EmailAddress'  64 characters  before @ ****************")
        ...
        self.driver.find_element_by_id("emailAddress").send_keys(
            "abcdefghijklmnoabcdefghijklmno@abc.com")
