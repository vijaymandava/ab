...
class Test_023_CreateUser_UserName_NumbersOnly:
    ...
    def test_userName_numbersOnly_023(self, setup):
        self.logger.info(
            "****************  test_023 ::  Test CreateUser when user sends 'userName' with values :: numbers only ****************")
        self.logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164248?projectId=50")
        print("****************  test_023 ::  Test CreateUser when user sends 'userName' with values :: numbers only ****************")
