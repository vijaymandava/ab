...
def test_cmRoles_list():
    ...
    #################Generating CMRoles list(Encrypted) ################
    r = requests.get(cmurl + "/roles/getCMRolesList", headers=accesstoken_headers)
    data = r.json()
