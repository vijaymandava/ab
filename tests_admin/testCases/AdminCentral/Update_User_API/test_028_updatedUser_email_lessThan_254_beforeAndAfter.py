...
def test_updateUser_email_below_254Characters_028():
    logger = LogGen.loggen()
    com = common_updateUser_api()
    logger.info(
        "****************  Test_028: Test updateUser when user sends  -  email  below 254 characters ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_028: Test updateUser when user sends  -  email  below 254 characters ****************")
    ...
    body['emailAddress'] = "abcdefghij@abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdeabcd.com"
