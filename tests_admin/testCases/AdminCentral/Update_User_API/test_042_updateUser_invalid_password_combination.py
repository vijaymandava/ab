...
def test_updateUser_invalid_password_combination_042():
    logger = LogGen.loggen()
    com = common_updateUser_api()
    logger.info("****************  Test_042: Test updateUser when user sends  -  invalid password combination ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_042: Test updateUser when user sends  -  invalid password combination ****************")
    ...
    body['password'] = "abcdabcd"
    body['confirmPassword'] = "abcdabcd"
