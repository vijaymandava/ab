...
def test_updateUser_sendBooleanValues_apartFrom_true_and_false_043():
    ...
    logger.info("****************  Test_043: Test updateUser by sending  the  boolean values apart from True or False ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_043: Test updateUser by sending  the  boolean values apart from True or False ****************")
