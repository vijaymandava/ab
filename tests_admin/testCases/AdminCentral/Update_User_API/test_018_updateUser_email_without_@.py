...
def test_updateUser_email_without_atTheRate_018():
    logger = LogGen.loggen()
    com = common_updateUser_api()
    logger.info("****************  Test_018: Test updateUser when user sends  -  Email without @ ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_018: Test updateUser when user sends  -  Email without @ ****************")
