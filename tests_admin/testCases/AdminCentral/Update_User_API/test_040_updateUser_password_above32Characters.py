...
def test_updateUser_password_above32Characters_040():
    logger = LogGen.loggen()
    com = common_updateUser_api()
    logger.info("****************  Test_040: Test updateUser when user sends  -  password above 32 characters ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_040: Test updateUser when user sends  -  password above 32 characters ****************")
    ...
    body['password'] = 'Abcd123456789Abcd123456789Abcd123456789Abcd123456789Abcd123456789Abcd123456789'
