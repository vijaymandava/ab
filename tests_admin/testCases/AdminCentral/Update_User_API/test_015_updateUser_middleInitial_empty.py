...
def test_updateUser_middleInitial_empty_015():
    logger = LogGen.loggen()
    com = common_updateUser_api()
    logger.info("****************  Test_015: Test updateUser when user sends  -  middleInitial value as empty ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_015: Test updateUser when user sends  -  middleInitial value as empty ****************")
    ...
    print("MiddleInitial is updating as NULL")
