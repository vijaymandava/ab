...
def test_updateUser_telephone_beginWithSpace_032():
    logger = LogGen.loggen()
    com = common_updateUser_api()
    logger.info("****************  Test_032: Test updateUser when user sends  -  telephone begin with space ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_032: Test updateUser when user sends  -  telephone begin with space ****************")
