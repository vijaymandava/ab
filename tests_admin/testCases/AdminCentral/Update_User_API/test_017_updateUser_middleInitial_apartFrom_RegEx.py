...
def test_updateUser_middleInitial_apartFrom_RegEx_017():
    ...
    logger.info("****************  Test_017: Test updateUser when user sends  -  middleInitial apart from RegEx ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_017: Test updateUser when user sends  -  middleInitial apart from RegEx ****************")
