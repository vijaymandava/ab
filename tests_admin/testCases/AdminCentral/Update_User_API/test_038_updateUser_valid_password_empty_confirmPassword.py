...
def test_updateUser_valid_password_empty_confirmPassword_038():
    logger = LogGen.loggen()
    com = common_updateUser_api()
    logger.info("****************  Test_038: Test updateUser when user sends  -  valid password and empty ConfirmPassword ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_038: Test updateUser when user sends  -  valid password and empty ConfirmPassword ****************")
