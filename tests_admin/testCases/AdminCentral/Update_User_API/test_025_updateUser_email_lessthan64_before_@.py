...
def test_updateUser_email_with_lessthan_64Characters_before_atTheRate_025():
    logger = LogGen.loggen()
    com = common_updateUser_api()
    logger.info("****************  Test_025: Test updateUser when user sends  -  Email with lessthan 64 characters before @ ****************")
    logger.info("https://rapidmicrobiosystems.jamacloud.com/perspective.req#/testCases/164311?projectId=50")
    print("****************  Test_025: Test updateUser when user sends  -  Email with lessthan 64 characters before @ ****************")
    ...
    body['emailAddress'] = "abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcd@a.com"
