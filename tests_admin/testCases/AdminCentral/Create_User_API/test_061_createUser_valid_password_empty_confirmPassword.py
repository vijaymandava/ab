...
def test_createUser_valid_password_empty_confirmPassword_061():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  IN Description Testcase_061: Test CreateUser when user sends  -  valid password and empty ConfirmPassword ****************")
    print("In Description :Testcase_061: Test CreateUser when user sends  -  valid password and empty ConfirmPassword ")
    logger.info(
