...
def test_createUser_without_email_008():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  In Description :TestCase_008: Test CreateUser when user sends  - without emailAddress ****************")
    print("In Description :TestCase_008: Test CreateUser when user sends  - without emailAddress")
    logger.info(
    ...
    print(" Email field is not sending in the body")
    body = {
    "editedBy": "vijay", "userName": "Operator", "firstName": "v", "middleInitial":"i", "lastName":"j",
    "telephoneNumber": "123456", "extension": "5309", "password": 'Password123',
