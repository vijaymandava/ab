...
def test_createUser_email_apartFrom_RegEx_046():
    ...
    logger.info("****************  Test_046: Test CreateUser when user sends  -  Email with apart from RegEx ****************")
    print("In Description :Test_046: Test CreateUser when user sends  -  Email with apart from RegEx")
    logger.info(
