...
def test_createuser_userName_decimalNumbers_019():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_019: Test CreateUser when user sends  -  userName with decimalNumbers ****************")
    print("In Description : Test_019: Test CreateUser when user sends  -  userName with decimalNumbers")
    logger.info(
    ...
    userName = user.username_decimal()
    file_body = readFiles()
