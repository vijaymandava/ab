...
def test_createuser_userName_upperCase_characters_008():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_008: Test CreateUser when user sends  -  userName with UpperCase characters ****************")
    print("In Description :Test_008: Test CreateUser when user sends  -  userName with UpperCase characters")
    logger.info(
    ...
    userName = user.username_uppercase()
    file_body = readFiles()
