...
def test_createUser_userName_single_character_021():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_021: Test CreateUser when user sends  -  userName with single character ****************")
    print("In Description :Test_021: Test CreateUser when user sends  -  userName with single character ")
    logger.info(
    ...
    userName = user.username_single_character()
    file_body = readFiles()
