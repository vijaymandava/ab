...
def test_createuser_userName_lowerCase_characters_009():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_009: Test CreateUser when user sends  -  userName with LowerCase characters ****************")
    print("In Description :Test_009: Test CreateUser when user sends  -  userName with LowerCase characters")
    logger.info(
