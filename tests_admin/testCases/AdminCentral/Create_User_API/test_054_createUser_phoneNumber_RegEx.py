...
def test_createUser_telephone_RegEx_054():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("**************** In Description: Test_054: Test CreateUser when user sends  -  telephone with RegEx ****************")
    print("In Description :TestCase_054: Test CreateUser when user sends  -  telephone with RegEx")
    logger.info(
    ...
    telephoneNumber = telephone.telephonenumber_regex()
