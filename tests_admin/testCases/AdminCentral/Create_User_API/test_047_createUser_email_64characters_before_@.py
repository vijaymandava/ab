...
def test_createUser_email_with_64Characters_before_atTheRate_047():
    ...
    logger.info("****************  Test_047: Test CreateUser when user sends  -  Email with 64 characters before @ ****************")
    print("In Description :Test_047: Test CreateUser when user sends  -  Email with 64 characters before @")
    logger.info(
    ...
    emailAddress = 'abcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcdefghijabcd@a.com'
