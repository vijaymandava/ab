...
def test_createUser_password_above32Characters_063():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("**************** In Description: Test_063: Test CreateUser when user sends  -  password above 32 characters ****************")
    print("In Description : In Description: Test_063: Test CreateUser when user sends  -  password above 32 characters")
    logger.info(
    ...
    body['password'] = "abcdAbcd123abcdAbcd123abcdAbcd123abcdAbcd123abcdAbcd123"
    body['confirmPassword'] = 'abcdAbcd123abcdAbcd123abcdAbcd123abcdAbcd123abcdAbcd123'
