...
def test_createuser_userName_max50_005():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_005: Test CreateUser when user sends  -  userName with maximum value(50) ****************")
    print("In Description :Test_005: Test CreateUser when user sends  -  userName with maximum value(50)")
    logger.info(
    ...
    userName = user.username_max_characters()
    file_body = readFiles()
