...
def test_createuser_userName_characters_011():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_011: Test CreateUser when user sends  -  characters ****************")
    print("In Description : Test_011: Test CreateUser when user sends  -  characters")
    logger.info(
