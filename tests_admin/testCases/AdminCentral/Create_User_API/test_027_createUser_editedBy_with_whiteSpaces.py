...
def test_createUser_userName_editedBy_with_whiteSpaces_027():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_027: Test CreateUser when user sends EditedBy values with whiteSpaces")
    print("In Description : Test_027: Test CreateUser when user sends EditedBy values with whiteSpaces")
    logger.info(
