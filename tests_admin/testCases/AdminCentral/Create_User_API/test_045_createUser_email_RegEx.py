import pytest
from tests_admin.Field_Validations.emailAddress_field_validations import emailAddress_field_validations
...
def test_createUser_email_RegEx_045():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_045: Test CreateUser when user sends  -  Email with RegEx ****************")
    print("In Description :Test_045: Test CreateUser when user sends  -  Email with RegEx")
    logger.info(
    ...
    email = emailAddress_field_validations()
    emailAddress = email.email_regex()
