...
def test_createUser_userRole_administrator_067():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("**************** In Description : TestCase_067: Test Default Administrator and its default User Role Settings ****************")
    print("In Description :TestCase_067: Test Default Administrator and its default User Role Settings")
    logger.info(
    ...
    body['userRoleName'] = name
    body['userName'] = name

    com.create_user_negative(body, name)

    com.verify_users_from_sm_with_api(name)
