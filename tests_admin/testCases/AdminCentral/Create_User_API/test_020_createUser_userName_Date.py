...
def test_createuser_userName_date_020():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_020: Test CreateUser when user sends  -  userName with date ****************")
    print("In Description :Test_020: Test CreateUser when user sends  -  userName with date")
    logger.info(
