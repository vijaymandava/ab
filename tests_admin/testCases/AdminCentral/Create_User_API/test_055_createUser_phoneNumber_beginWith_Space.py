...
def test_createUser_telephone_beginWithSpace_055():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("**************** In Description :TestCase_055: Test CreateUser when user sends  -  telephone begin with space ****************")
    print("In Description : TestCase_055: Test CreateUser when user sends  -  telephone begin with space")
    logger.info(
    ...
    telephoneNumber = telephone.telephone_begin_with_space()
