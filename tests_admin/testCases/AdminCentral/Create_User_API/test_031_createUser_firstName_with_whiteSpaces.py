...
def test_createUser_firstName_with_whiteSpaces_031():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_031: Test CreateUser when user sends  -  firstName with white spaces ****************")
    print("In Description :Test_031: Test CreateUser when user sends  -  firstName with white spaces")
    logger.info(
