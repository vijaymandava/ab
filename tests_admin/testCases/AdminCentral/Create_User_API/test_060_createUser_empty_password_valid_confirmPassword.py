...
def test_createUser_empty_password_valid_confirmPassword_060():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("**************** In Description: TestCase_060: Test CreateUser when user sends  -  empty password and valid ConfirmPassword ****************")
    print("In Description :TestCase_060: Test CreateUser when user sends  -  empty password and valid ConfirmPassword")
    logger.info(
