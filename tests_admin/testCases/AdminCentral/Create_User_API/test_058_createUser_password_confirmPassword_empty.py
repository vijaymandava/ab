...
def test_createUser_password_confirmPassword_empty_058():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("**************** In Description : Testcase_058: Test CreateUser when user sends  -  password and ConfirmPassword empty ****************")
    print("In Description : Testcase_058: Test CreateUser when user sends  -  password and ConfirmPassword empty")
    logger.info(
