...
def test_createUser_lastName_whiteSpaces_035():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_035: Test CreateUser when user sends  - Lastname whiteSpaces ****************")
    print("In Description :Test_035: Test CreateUser when user sends  - Lastname whiteSpaces")
    logger.info(
