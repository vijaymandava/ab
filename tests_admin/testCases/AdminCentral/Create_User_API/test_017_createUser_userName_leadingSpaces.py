...
def test_createUser_userName_leadingSpaces_017():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_017: Test CreateUser when user sends  -  userName with leadingSpaces ****************")
    print("In Description :Test_017: Test CreateUser when user sends  -  userName with leadingSpaces ")
    logger.info(
    ...
    userName = user.username_leading_spaces()
    file_body = readFiles()
