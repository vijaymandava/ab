...
def test_createUser_middleInitial_empty_038():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_038: Test CreateUser when user sends  -  middleInitial value as empty ****************")
    print("In Description : Test_038: Test CreateUser when user sends  -  middleInitial value as empty")
    logger.info(
