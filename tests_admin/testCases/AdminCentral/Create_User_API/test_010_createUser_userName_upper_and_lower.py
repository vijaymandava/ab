...
def test_createuser_userName_upperCase_lowerCase_characters_010():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_010: Test CreateUser when user sends  -  userName with UpperCase and lowerCase characters ****************")
    print("In Description :Test_010: Test CreateUser when user sends  -  userName with UpperCase and lowerCase characters")
    logger.info(
    ...
    userName = user.username_upper_lower()
    file_body = readFiles()
