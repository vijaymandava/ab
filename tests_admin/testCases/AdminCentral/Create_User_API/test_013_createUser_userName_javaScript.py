...
def test_createUser_userName_javeScript_013():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("****************  Test_013: Test CreateUser when user sends  -  javascript ****************")
    print("In Description : Test_013: Test CreateUser when user sends  -  javascript")
    logger.info(
    ...
    userName = user.username_javascript()
    file_body = readFiles()
