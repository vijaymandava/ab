...
def test_createUser_userRole_operator_069():
    logger = LogGen.loggen()
    com = common_createUser_api()
    logger.info("**************** In Description: TestCase_069: Test Default Operator and its default User Role Settings ****************")
    print("In Description :TestCase_069: Test Default Operator and its default User Role Settings")
    logger.info(
