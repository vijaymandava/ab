...
class Test_020_CreateRole_RoleName_SQLinjection:
    ...
    def test_roleName_SQLinjection_020(self, setup):
        self.logger.info("****************  test_020 ::  Test CreateRole when user sends 'userRoleName' with values :: SQL injection ****************")
        print(
            "In Description : TestCase_020 ::  Test CreateRole when user sends 'userRoleName' with values :: SQL injection")
