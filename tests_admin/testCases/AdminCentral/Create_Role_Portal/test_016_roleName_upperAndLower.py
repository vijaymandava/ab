...
class Test_016_CreateRole_RoleName_UpperAndLower:
    ...
    def test_roleName_upperAndLower_016(self, setup):
        self.logger.info(
            "****************  Test_016: Test CreateRole when user sends userRoleName with values :: upper and lowercase alphabets ****************")
        print(
            "In Description : TestCase_016: Test CreateRole when user sends userRoleName with values :: upper and lowercase alphabets ")
