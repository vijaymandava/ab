...
class Test_027_CreateRole_RoleName_SelectAllOptions:
    ...
    def test_roleName_selectAllOptions_027(self,setup):
        self.logger.info("****************  Test_027 - Test CreateRole when user Click ADD button and selectAll options. ****************")
        print(
            "In Description : TestCase_027 - Test CreateRole when user Click ADD button and selectAll options.")
