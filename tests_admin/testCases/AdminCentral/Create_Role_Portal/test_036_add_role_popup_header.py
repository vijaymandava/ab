...
class Test_036_Add_Role_Header:
    ...
    def test_addRole_header_036(self,setup):
        self.logger.info("****************  Test_036 : Test CreateRole when user Click ADD button and verify addrole header ****************")
        print("In Description : Test_036 : Test CreateRole when user Click ADD button and verify addrole header. ")
