...
$Env:PYTHONPATH= $Env:PYTHONPATH + ';' + $PWD + '\Configurations'
$Env:PYTHONPATH= $Env:PYTHONPATH + ';' + $PWD + '\Drivers'
$Env:PYTHONPATH= $Env:PYTHONPATH + ';' + $PWD + '\pageObjects'
$Env:PYTHONPATH= $Env:PYTHONPATH + ';' + $PWD + '\utilities'


################################################
# add to PATH for selenium web drivers
$Env:PATH= $Env:PATH + ';' + $PWD + '\Drivers;'
